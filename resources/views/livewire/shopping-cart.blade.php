...
{{--                        <td>--}}
{{--                            <div class="flex">--}}
{{--                                <img class="h-15 w-20 object-cover mr-4" src="{{$item->options->image}}" alt="{{$item->name}}">--}}
{{--                                <div>--}}
{{--                                    <p class="font-bold">{{$item->name}}</p>--}}
{{--                                    @if($item->options->color)--}}
{{--                                        <span>--}}
...
{{--            <div class="flex flex-col items-center">--}}
{{--                <x-cart />--}}
{{--                <p class="text-lg text-gray-700 mt-4">Tú carrito de compras está vacío</p>--}}
{{--                <x-button-enlace color="blue" class="mt-4 px-16" href="{{route('index')}}">--}}
{{--                    Ir al inicio--}}
{{--                </x-button-enlace>--}}
{{--            </div>--}}
{{--        @endif--}}
